...
/Users/felipegomez/google-cloud-sdk/bin/gcloud run deploy $SERVICE_NAME \
  ...
  --set-env-vars="SERVICE_TYPE=unified,DASHBOARD_URL=https://app.fgate.co,GOOGLE_CLIENT_ID=1054327025113-765gvg5r9kjci5kbucurijnp0ih1ap7e.apps.googleusercontent.com,WEBHOOK_URL=https://membership-backend-dhtw77aq7a-uc.a.run.app" \
  --project $PROJECT_ID \
  --quiet
