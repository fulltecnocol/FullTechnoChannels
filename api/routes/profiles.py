...
from shared.models import User, PublicProfile, ProfileLink
from api.deps import get_current_owner
...
@router.get("/owner/profile", response_model=PublicProfileRead, tags=["Owner"])
...
@router.put("/owner/profile", response_model=PublicProfileRead, tags=["Owner"])
