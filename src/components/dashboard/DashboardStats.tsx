import { Users, Wallet, TrendingUp, LayoutGrid } from 'lucide-react';
...
export function DashboardStats({ summary }: DashboardStatsProps) {
    ...
    return (
        <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 animate-fade-in-up">
            {stats.map((stat, i) => (
                <div key={i} className="premium-card p-6 border-surface-border bg-gradient-to-br from-surface to-background relative overflow-hidden group hover:scale-[1.02] transition-transform">
