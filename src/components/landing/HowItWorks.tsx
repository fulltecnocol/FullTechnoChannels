            ...
            <div className="pt-20 pb-20">
                ...
                <section className="max-w-7xl mx-auto px-6 mb-40">
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="lg:w-1/2 space-y-8">
                            ...
                            <h3 className="text-4xl font-black tracking-tight">El Cerebro Digital</h3>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
                            <div className="lg:w-1/2 space-y-8">
                                ...
                                <h3 className="text-4xl font-black tracking-tight">El Motor Financiero</h3>
                                <p className="text-lg text-muted leading-relaxed font-medium">
                ...
                <section className="max-w-7xl mx-auto px-6 mb-32">
                    <div className="text-center mb-20 space-y-6">
                        ...
                        <h3 className="text-4xl lg:text-6xl font-black tracking-tighter">La Red de Poder</h3>
                        <p className="text-xl text-muted max-w-2xl mx-auto">
                            Transformamos la competencia en colaboración. Invita a otros <span className="text-white font-bold">Creadores de Contenido</span> a FGate y obtén una participación de sus ganancias netas automáticamente hasta <span className="text-primary font-bold">10 niveles de profundidad</span>.
                        </p>
                    </div>
                            ...
                            <div className="sticky top-32 space-y-8">
                                <div className="premium-card p-8 bg-gradient-to-br from-surface to-background border-primary/20">
                                    ...
                                    <div className="mt-8 pt-6 border-t border-surface-border">
                                        <a href="https://app.fgate.co/register" className="w-full py-4 bg-primary text-primary-foreground rounded-xl flex items-center justify-center gap-2 font-black text-lg hover:bg-accent-gold transition-colors">
