...
const ProductShowcase = dynamic(() => import("@/components/landing/ProductShowcase").then(mod => mod.ProductShowcase), {
    ssr: false,
    loading: () => <div className="h-[50vh] flex items-center justify-center bg-background"><div className="w-10 h-10 border-4 border-primary border-t-transparent rounded-full animate-spin" /></div>
});
    ...
    return (
        <div className="min-h-screen bg-background text-foreground overflow-x-hidden selection:bg-primary/30">
                ...
                <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
                    <Link href="/" className="flex items-center gap-3 group">
                        ...
                        <span className="font-black text-2xl tracking-tighter text-white">
                            F<span className="text-primary italic">Gate</span>
                        </span>
                    </Link>
                    ...
                    <div className="hidden md:flex items-center gap-8">
                        ...
                        <a href="https://app.fgate.co/login" className="text-sm font-bold text-muted hover:text-foreground transition-colors">Login</a>
                        <Button asChild className="bg-primary hover:bg-primary/90 text-primary-foreground font-black rounded-xl px-6">
                            <a href="https://app.fgate.co/register">Empezar Ahora</a>
                        </Button>
                    </div>
                ...
                {mobileMenuOpen && (
                    ...
                    >
                        <div className="flex flex-col gap-6">
                            ...
                            <a href="https://app.fgate.co/login" className="text-2xl font-black text-muted" onClick={() => setMobileMenuOpen(false)}>Login</a>
                            <Button asChild size="lg" className="w-full text-lg h-14 font-black">
                                <a href="https://app.fgate.co/register">Registrarse</a>
                            </Button>
                        </div>
                    </motion.div>
                )}
            ...
            <main>
                ...
                <section className="relative pt-24 pb-12 md:pt-32 md:pb-20 px-6 overflow-hidden">
                    ...
                    <div className="max-w-5xl mx-auto text-center space-y-8">
                        ...
                        >
                            ...
                            <span className="text-[10px] font-black uppercase tracking-widest text-primary">FGate v2.5 Operativo</span>
                        </motion.div>
                        ...
                        >
                            <a href="https://app.fgate.co/register" className="flex items-center">
                ...
                {/* Triple Feature Grid */}
                <section id="features" className="pt-12 pb-20 px-6">
                ...
                <section className="py-20 px-6 bg-surface/30 border-y border-surface-border">
                    <div className="max-w-4xl mx-auto text-center space-y-8">
                        ...
                        <Button asChild size="lg" className="h-16 px-12 bg-primary text-primary-foreground font-black text-xl rounded-2xl hover:scale-105 active:scale-95 transition-all">
                            <a href="https://app.fgate.co/register">Registrar Mi Canal VIP</a>
                        </Button>
                    </div>
                </section>
            </main>
            ...
            <footer className="py-12 px-6 border-t border-surface-border">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
                    <div className="flex items-center gap-3">
                        ...
                        <span className="font-bold text-white">FGate</span>
