...
from core.entities import User as DBUser, RegistrationToken
...
async def google_auth(
    ...
    try:
        ...
        if not CLIENT_ID:
            logger.error("google_auth_missing_client_id")
            raise HTTPException(status_code=500, detail="Configuración de Google incompleta")
        ...
        logger.error("google_auth_invalid_token", error=str(e))
