...
gcloud run deploy $MAIN_SERVICE \
  ...
  --set-env-vars="SERVICE_TYPE=unified,WORKER_URL=$WORKER_URL,WEBHOOK_URL=https://membership-backend-1054327025113.us-central1.run.app,GOOGLE_CLIENT_ID=1054327025113-765gvg5r9kjci5kbucurijnp0ih1ap7e.apps.googleusercontent.com" \
  --quiet
