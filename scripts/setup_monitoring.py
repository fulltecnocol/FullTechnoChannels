...
def create_error_rate_alert():
    ...
    alert_config = {
        ...
        "conditions": [{
            ...
            "conditionThreshold": {
                "filter": f'resource.type="cloud_run_revision" AND resource.labels.service_name="membership-backend" AND metric.type="run.googleapis.com/request_count" AND metric.labels.response_code_class="5xx"',
