...
import { Bot, LayoutGrid, Users, Zap, LifeBuoy, ShieldCheck, Wallet, Settings, ShieldEllipsis, CreditCard, LogOut, Phone } from 'lucide-react';
...
export function DashboardSidebar({ activeTab, setActiveTab, setIsViewingAsAdmin, summary, handleLogout }: DashboardSidebarProps) {
    const menuItems = [
        ...
        { id: "calls", label: "Llamadas Privadas", icon: Phone },
